			...
			Stevenson.repo.getEditorConfig({
				...
				error:  function(message){
					...
					Stevenson.ui.Messages.displayError('Exception loading properties editor: '
							+ message+', if you haven\'t already, <a href="' + Stevenson.Account.siteBaseURL + '/cms/edit.html?new=true#' + Stevenson.Account.siteBaseURL + Stevenson.Account.schemasPath + '/schemas/' + schema + '.json">configure the schema for this configuration</a>.');
				},
